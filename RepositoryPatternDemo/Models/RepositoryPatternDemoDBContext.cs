...
{
    public partial class RepositoryPatternDemoDBContext : DbContext
    {
        public RepositoryPatternDemoDBContext()
        {
        }

        public RepositoryPatternDemoDBContext(DbContextOptions<RepositoryPatternDemoDBContext> options)
            : base(options)
        {
        }
